...
<div class="row px-4">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/projects/radar-a-light.svg" title="example image" class="img-fluid only-light" %}
        {% include figure.liquid loading="eager" path="assets/img/projects/radar-a-dark.svg" title="example image" class="img-fluid only-dark" %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/projects/radar-b-light.svg" title="example image" class="img-fluid only-light" %}
        {% include figure.liquid loading="eager" path="assets/img/projects/radar-b-dark.svg" title="example image" class="img-fluid only-dark" %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/projects/radar-c-light.svg" title="example image" class="img-fluid only-light" %}
        {% include figure.liquid loading="eager" path="assets/img/projects/radar-c-dark.svg" title="example image" class="img-fluid only-dark" %}
    </div>
</div>
<div class="caption">
...
<div class="publications">
  {% bibliography -f project-electrodes --group_by none %}
</div>