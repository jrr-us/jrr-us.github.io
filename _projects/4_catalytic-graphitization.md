...
1. **Dissolution-Precipitation:** Disordered carbon dissolves into a tiny iron particle and then "pops out" as perfectly structured graphite layers.
2. **Carbide Formation:** The iron reacts with carbon to form a "metal carbide" (like Fe$_3$C), which then decomposes to leave behind graphitic structures.

Our research group, in collaboration with [Prof. Schnepp's group](https://www.birmingham.ac.uk/staff/profiles/chemistry/schnepp-zoe) at the University of Birmingham, has focused on bridging the gap between raw biological resources and high-end technology. We specialize in converting natural biomass—such as wood and other plant-derived materials—into advanced carbons for electrochemical energy storage and wastewater treatment.
...
<div class="publications">
  {% bibliography -f catalytic-graphitization --group_by none %}
</div>