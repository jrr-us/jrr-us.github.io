...
## The structure of hard vs. soft carbons

Rosalind Franklin proposed a structural model for hard and soft carbons in 1951. You can see the structure in the image below:

<div class="row">
    <div class="col-lg-6 col-md-8 mt-3 mt-md-0 mx-auto">
        {% include figure.liquid loading="eager" path="assets/img/projects/franklin-carbon-structure.jpg" title="Franklin's carbon model" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
